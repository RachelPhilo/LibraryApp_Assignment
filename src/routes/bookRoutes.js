...
const Bookdata = require('../model/Bookdata'); //Acessing DB model Bookdata
...
booksRouter.get('/',function(req,res){
    Bookdata.find() //Finding Books from DB
    .then(function(books){
        res.render("books",
        {
    ...
    booksRouter.get('/:id',function(req,res){
        ...
        Bookdata.findOne({_id:id}) //To find a single book with _id in DB 
        .then(function(book){
            res.render('book',
        {
            // nav:[{link:'/books',name:'Books'},{link:'/authors',name:'Authors'}],
            ...
            title:'Book',
            book
            // book:books[id]   //key value pair in object when using books array
        });
